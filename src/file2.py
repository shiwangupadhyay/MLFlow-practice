...
dagshub.init(repo_owner='shiwangupadhyay', repo_name='MLFlow-practice', mlflow=True)


mlflow.set_tracking_uri("https://dagshub.com/shiwangupadhyay/MLFlow-practice.mlflow")
